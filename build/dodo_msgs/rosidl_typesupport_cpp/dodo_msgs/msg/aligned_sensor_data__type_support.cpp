...
static const _AlignedSensorData_type_support_symbol_names_t _AlignedSensorData_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, dodo_msgs, msg, AlignedSensorData)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, dodo_msgs, msg, AlignedSensorData)),
  }
};
...
{
  return &::dodo_msgs::msg::rosidl_typesupport_cpp::AlignedSensorData_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, dodo_msgs, msg, AlignedSensorData)() {
  return get_message_type_support_handle<dodo_msgs::msg::AlignedSensorData>();
}
