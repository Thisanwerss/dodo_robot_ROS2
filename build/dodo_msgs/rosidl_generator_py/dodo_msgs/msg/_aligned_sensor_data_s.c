...
bool dodo_msgs__msg__aligned_sensor_data__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("dodo_msgs.msg._aligned_sensor_data.AlignedSensorData", full_classname_dest, 52) == 0);
  }
  dodo_msgs__msg__AlignedSensorData * ros_message = _ros_message;
  {  // header
  ...
  {  // time_offset
    ...
    ros_message->time_offset = PyFloat_AS_DOUBLE(field);
    Py_DECREF(field);
  }
...
{
  /* NOTE(esteve): Call constructor of AlignedSensorData */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("dodo_msgs.msg._aligned_sensor_data");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "AlignedSensorData");
  ...
  {  // time_offset
    PyObject * field = NULL;
    field = PyFloat_FromDouble(ros_message->time_offset);
    {
